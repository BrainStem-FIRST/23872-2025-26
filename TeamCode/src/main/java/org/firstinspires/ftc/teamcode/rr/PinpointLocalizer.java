...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -107.951 ; //in MM y position of the parallel encoder (in tick units) y distance  to center
        public double perpXTicks = -92.006; //  in MM x position of the perpendicular encoder (in tick units) x distance
    }
