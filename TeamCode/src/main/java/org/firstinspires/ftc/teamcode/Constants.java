...
public class Constants {
        ...
        public static final class ShooterConstants {
            ...
            // PID Constants
            public static final double kP_ONE = 0.001;
            public static final double kP_TWO = 0.001;
            public static final double kI = 0.0;
            public static final double kD = 0.000;
            public static final double kF = 0.0;
            public static final double kV1 = 0.00049;
            public static final double kV2 = 0.00044;

            // Vel Targets (ticks per second)
            public static final double AUTO_VEL = 300;
            public static final double FAR_SHOOT_VEL = 1060;
            public static final double CLOSE_SHOOT_VEL = 300;
            ...
            // Motor Configuration
            public static final boolean POWER_MOTORS = true;
        }
        ...
        public static final class SpindexerConstants {
            ...
            // PID Constants
            public static final double INDEXER_KP = 0.0188;
        ...
        public static class CollectorConstants {
            ...
            public static final double AUTO_POWER = 0.77;
            public static final double OFF_POWER = 0.0;
        }

        public static final class FingerConstants {
    ...
    public static final class DriveConstants {
            ...
            public static final double ALIGNMENT_KP = 1.1;
            public static final double ALIGNMENT_KI = 0.13;
            public static final double ALIGNMENT_KD = 0.0;
