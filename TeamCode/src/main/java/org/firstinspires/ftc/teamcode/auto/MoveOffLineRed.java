...
@Autonomous(name="Move Off Line Red", group = "RED")
@Config

public class MoveOffLineRed extends LinearOpMode {
    ...
    public static MoveOffLineRed.PARAMS PARAMS = new MoveOffLineRed.PARAMS();
